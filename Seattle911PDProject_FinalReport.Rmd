...
### Random Forest: Growing the tree
...
```{r,plot-rf-tuning, fig.cap='Random Forest Parameter Tuning', fig.subcap=c('Sample 10.000','Sample 50.000','Sample 100.000'), fig.show="hold", out.width="30%", echo=FALSE}
knitr::include_graphics(c("images/Rplot_RF_MTry_Ntree500_nSamp10000_LatLongITDescNEC_YearEC_QuarterEC_MonthEC_DayEC_Weekday_Mtry10_200_data10000.png","images/Rplot_RF_MTry_Ntree500_nSamp10000_ECCLatLongITDescNEC_YearEC_QuarterEC_MonthEC_DayEC_Weekday_Mtry10_200_data50000.png","images/Rplot_RF_MTry_Ntree500_nSamp10000_ECCLatLongITDescNEC_YearEC_QuarterEC_MonthEC_DayEC_Weekday_Mtry10_200_data100000.png"))
```
...
```{r,plot-rf-importance, fig.cap='Random Forest Variable Importance', fig.show="hold", out.width="80%", echo=FALSE}
knitr::include_graphics(c("images/Rplot_varImpPlot.png"))
```
...
Tuning for 8 Features and k=seq(10,100,10). Training algorithm ran 67 minutes for this tuning range. Although, this tuning yielded inconclusive results.
...
Tried again with 3 Features and k=seq(10,100,10). Final training script ran 192 minutes for 100'000 data.
...
```{r,plot-knn-tuning, fig.cap='knn Parameter Tuning', fig.show="hold", out.width="80%", echo=FALSE}
knitr::include_graphics(c("images/Rplot_KnnTraining3Features.png"))
```
...
## About the Similarity between 911 calls and 103 calls
