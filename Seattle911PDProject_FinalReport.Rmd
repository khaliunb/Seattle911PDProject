...
```{r dataprep-file-source, include=TRUE}
...
```{r, echo=FALSE,out.width="49%",out.height="49%",fig.show='hold', fig.align='center', fig.cap="This is the main caption - Years 2020 - 2030 - the main caption."}
knitr::include_graphics(c("images/Rplot1_ECDOverallOccurence_80MBData.png","images/Rplot1_ECDOverallOccurence_FullData.png"))
```

From the plot we see four bars that significantly exceed 20'000 in total occurence. For full data, this number rises above 50'000. 
